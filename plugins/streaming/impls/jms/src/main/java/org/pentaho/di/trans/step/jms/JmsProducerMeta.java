...
import static org.pentaho.di.trans.step.jms.JmsProducerMeta.JMS_TOPIC_METAVERSE;
...
@Metaverse.CategoryMap ( entity = JMS_TOPIC_METAVERSE, category = CATEGORY_MESSAGE_QUEUE )
...
@Metaverse.EntityLink ( entity = JMS_TOPIC_METAVERSE, link = LINK_CONTAINS_CONCEPT, parentEntity = JMS_SERVER_METAVERSE )
@Metaverse.EntityLink ( entity = JMS_TOPIC_METAVERSE, link = LINK_PARENT_CONCEPT )
public class JmsProducerMeta extends BaseSerializingMeta implements StepMetaInterface {
  ...
  public static final String JMS_TOPIC_METAVERSE = "JMS Topic";
