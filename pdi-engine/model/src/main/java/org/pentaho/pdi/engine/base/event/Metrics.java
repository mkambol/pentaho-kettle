...
public class Metrics implements Serializable {
  ...
  @JsonCreator
  public Metrics( @JsonProperty( "in" ) long in, @JsonProperty( "out" ) long out,
                  @JsonProperty( "dropped" ) long dropped, @JsonProperty( "inFlight" ) long inFlight ) {
    this.in = in;
    this.out = out;
  ...
  /**
   * Get number of rows into this component
   *
   * @return row count
   */
  public long getIn() {
  ...
  /**
   * Get number of rows out from this component
   *
   * @return row count
   */
  public long getOut() {
  ...
  /**
   * Get number of rows dropped (errorred)
   *
   * @return row count
   */
  ...
  /**
   * Get number of rows currently in-flight
   *
   * @return row count
   */
